...
print('Basic use ohlcv "2005-01-01 00:00:00","2020-05-13 10:11:00" with no universe add')
start_time = time.time()
# if no input in universe list. class will return All stock company 
stock_table_muti_format = finnix_data.SETData("2005-01-01 00:00:00","2020-05-13 10:11:00",['AOT','PTT','2S'])
